defmodule SalvaCompraWeb.UserControllerTest do
  use SalvaCompraWeb.ConnCase

  alias SalvaCompra.Accounts

  @create_attrs %{email: "some email", filial_id: 42, funcionario_id: 42, login: "some login", nome: "some nome", password_hash: "some password_hash", telefone: "some telefone"}
